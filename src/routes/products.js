...
router.put("/createProduct", guestMiddleware, productosController.store); //accion creación de productos
router.get("/:id/editProduct", productosController.editar); //Formulario de edición de productos
router.put("/:id/editProduct", guestMiddleware, productosController.update); //Acción de edición (a donde se envía el formulario):
